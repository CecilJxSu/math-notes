...
\begin{figure}[H]
\centering
  \input{figure/differential_of_arc}
  \caption{弧微分}
  \label{弧微分}
\end{figure}
...
\centering
  ...
  \begin{subfigure}[t]{0.45\linewidth}
    \centering
      \input{figure/curvature_exam1}
      \subcaption{切线转过的角度$\varphi$不同}
      \label{curvature_exam1}
  \end{subfigure}
  \begin{subfigure}[t]{0.45\linewidth}
    \centering
      \input{figure/curvature_exam2}
...
\begin{figure}[H]
\centering
  \input{figure/curvature_concept}
  \caption{曲率概念}
  \label{曲率概念}
\end{figure}
...
\begin{figure}[H]
\centering
  \input{figure/curvature_and_circle}
  \caption{曲率圆}
  \label{曲率圆}
\end{figure}
