...
\begin{figure}[H]
  \centering
    \input{figure/2_e_distribution_density_func.tex}
    \caption{指数分布的概率密度函数}
    \label{指数分布的概率密度函数}
\end{figure}
...
\centering
  ...
  \begin{subfigure}[t]{0.48\linewidth}
    \centering
      \input{figure/2_n_distribution_density_func_mu.tex}
  \end{subfigure}
  \begin{subfigure}[t]{0.48\linewidth}
    \centering
      \input{figure/2_n_distribution_density_func_sigma.tex}
  \end{subfigure}
  \caption{正态分布的概率密度函数}
  \label{正态分布的概率密度函数}
\end{figure}
...
\centering
  ...
  \begin{subfigure}[t]{0.48\linewidth}
    \centering
      \input{figure/2_n_distribution_func.tex}
      \caption{正态分布的分布函数}
  \end{subfigure}
  \begin{subfigure}[t]{0.48\linewidth}
    \centering
      \input{figure/2_normal_n_distribution_density_func.tex}
