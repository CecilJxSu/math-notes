...
\centering
  ...
  \begin{subfigure}[t]{0.3\linewidth}
    \centering
      \input{figure/1_A_subset_B.tex}
      \caption{$A \subset B$}
      \label{1_A_subset_B}
  \end{subfigure}
  \begin{subfigure}[t]{0.3\linewidth}
    \centering
      \input{figure/1_A_cup_B.tex}
      \caption{$A \cup B$}
      \label{1_A_cup_B}
  \end{subfigure}
  \begin{subfigure}[t]{0.3\linewidth}
    \centering
      \input{figure/1_A_cap_B.tex}
      \caption{$A \cap B$}
      \label{1_A_cap_B}
  \end{subfigure}
  ...
  \begin{subfigure}[b]{0.3\linewidth}
    \centering
      \input{figure/1_A_difference_B.tex}
      \caption{$A - B$}
      \label{1_A_diffence_B}
  \end{subfigure}
  \begin{subfigure}[b]{0.3\linewidth}
    \centering
      \input{figure/1_A_cap_nothing_B.tex}
      \caption{$A \cap B = \varnothing$}
      \label{1_A_cap_nothing_B}
  \end{subfigure}
  \begin{subfigure}[b]{0.3\linewidth}
    \centering
      \input{figure/1_B_complement.tex}
